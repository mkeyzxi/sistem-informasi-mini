...
//             </tr>
//           </thead>
//           <tbody id="jadwal-dosen-body" class="bg-white divide-y divide-gray-200">
//             <tr><td colspan="4" class="text-center py-4">Memuat jadwal...</td></tr>
//           </tbody>
//         </table>
//       </div>
//     `;
...
//     const tableBody = document.getElementById('jadwal-dosen-body');
