...
// import { fetchCourses, createCourse, updateCourse, deleteCourse } from '../../api/courseApi.js';
...
//   },
//   after_render: async () => {
//     const pageContainer = document.querySelector('.px-4.sm\\:px-6.md\\:px-8'); // Parent container for event delegation
...
//                 <button class="text-indigo-600 hover:text-indigo-900 font-medium edit-btn">Edit</button>
//                 <button class="text-red-600 hover:text-red-900 font-medium delete-btn">Delete</button>
//             </div>
//           </div>
//         `).join('');
//       } else {
...
//       const parentElement = target.closest('tr') || target.closest('.bg-white.p-4'); // Target row or card
