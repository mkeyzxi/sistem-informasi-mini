...
//             <tr><td colspan="5" class="text-center py-4">Memuat logs...</td></tr>
//           </tbody>
//         </table>
//       </div>
//     `;
...
//         `).join('');
//       } else {
//         tableBody.innerHTML = `<tr><td colspan="5" class="text-center py-4">Tidak ada log ditemukan.</td></tr>`;
//       }
//     } catch (error) {
//       showNotification(error.message, true);
//       tableBody.innerHTML = `<tr><td colspan="5" class="text-center py-4 text-red-500">Gagal memuat logs.</td></tr>`;
//     }
//   },
// };
