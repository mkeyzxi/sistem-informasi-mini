...
//         <button id="add-user-btn" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700">
//           Add User
//         </button>
//       </div>
...
//             `).join('');
//         } else {
//             const noDataHTML = `<tr><td colspan="4" class="text-center py-4">Tidak ada pengguna.</td></tr>`;
//             const noDataCardHTML = `<div class="text-center py-4">Tidak ada pengguna.</div>`;
